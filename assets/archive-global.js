...
async function renderSearchPage() {
    ...
    contentContainer.innerHTML = `
        ...
        <p>Используйте расширенный поиск для глубокого анализа всей базы данных архива Kaeront. Система индексирует содержание всех доступных статей, чтобы найти даже самые специфические термины или упоминания. Если запрос требует уточнения, просто введите ключевое слово — архив автоматически подберет наиболее релевантные результаты для быстрого перехода к нужному разделу.</p>
